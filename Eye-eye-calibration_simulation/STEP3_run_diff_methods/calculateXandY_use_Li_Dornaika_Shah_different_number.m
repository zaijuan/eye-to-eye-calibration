function [ ERROR_ALL_RX_Li, ERROR_ALL_TX_Li, ERROR_ALL_RY_Li, ERROR_ALL_TY_Li,...
           ...
           ERROR_ALL_RX_Shah, ERROR_ALL_TX_Shah, ERROR_ALL_RY_Shah, ERROR_ALL_TY_Shah] = calculateXandY_use_Li_Dornaika_Shah_different_number( )
...
ERROR_ALL_RX_Li = zeros(100, 10);
ERROR_ALL_TX_Li = zeros(100, 10);
ERROR_ALL_RY_Li = zeros(100, 10);
ERROR_ALL_TY_Li = zeros(100, 10);
ERROR_ALL_RX_Dornaika = zeros(100, 10);
ERROR_ALL_TX_Dornaika = zeros(100, 10);
ERROR_ALL_RY_Dornaika = zeros(100, 10);
ERROR_ALL_TY_Dornaika = zeros(100, 10);
ERROR_ALL_RX_Shah = zeros(100, 10);
ERROR_ALL_TX_Shah = zeros(100, 10);
ERROR_ALL_RY_Shah = zeros(100, 10);
ERROR_ALL_TY_Shah = zeros(100, 10);
...
for iteration_run = 1:1:100
    ...
    for i=10:10:100   % i = 10, 20, 30, 40, 50, 60, 70, 80; j = 0, 1, 2, 3, 4, 5, 6, 7;
        
        measurement_number_column = measurement_number_column + 1;
        [AA, BB] = pick_out_random_dist_set( Ai_Bi_Bigsize_Level4, Ai_Bi_Smallsize_Level4, i);
